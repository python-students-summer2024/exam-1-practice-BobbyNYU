...
def weather_helper():
    ...
    if temperature < 40:
        is_snowing = input("Is it snowing? (yes/no) ").lower()
        if is_snowing in ["yes", "yeah", "yup"]:
            ...
            if is_raining in ["yes", "yeah", "yup"]:
                ...
                if has_umbrella in ["yes", "yeah", "yup"]:
                    print("Good job staying dry!")
                else:
                    print("You must enjoy getting wet!")

    elif temperature > 90:
        has_ac = input("Do you have air conditioning? (yes/no) ").lower()
        if has_ac in ["yes", "yeah", "yup"]:
